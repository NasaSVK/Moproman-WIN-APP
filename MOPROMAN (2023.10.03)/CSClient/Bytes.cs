...
namespace nsAspur
{
    ...
    class Bytes
    {
        ...
        public static Address VYKON = new Address() { AREA = S7Consts.S7AreaMK, DB_NUMBER = 0, OFFSET = 0, LENGTH = 4, AMOUNT_MAX = 148 };
        public static Address PRISPOSOBENIE = new Address() { AREA = S7Consts.S7AreaMK, DB_NUMBER = 0, OFFSET = 4, LENGTH = 4, AMOUNT_MAX = 148 };
